odoo.define('theme_vouge.bizcommon_frontend_js', function(require) {
    'use strict';
    ...
    animation.registry.theme_vouge_image_hotspot = animation.Class.extend({
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                if(self.hasClass('grid_style')){
                    $.get("/theme_vouge/get_product_configurator_grid_style", {
                ...
                if(self.hasClass('list_style')){
                    $.get("/theme_vouge/get_product_configurator_list_style", {
                        'product_id': self.attr('product_id') || '',
                        'product_limit': self.attr('product_limit') || 10,
                        'config_title': self.attr('config_title') || '',
                    }).then(function(data) {
                ...
                if(self.hasClass('slider_style')){
                    $.get("/theme_vouge/get_product_configurator_slider_style", {
                        'product_id': self.attr('product_id') || '',
                        'product_limit': self.attr('product_limit') || 10,
                        'config_title': self.attr('config_title') || '',
                ...
                if(self.hasClass('list_slider_style')){
                    $.get("/theme_vouge/get_product_configurator_list_slider_style", {
                        'product_id': self.attr('product_id') || '',
                        'product_limit': self.attr('product_limit') || 10,
                        'config_title': self.attr('config_title') || '',
                        'config_slider_description': self.attr('config_slider_description') || '',
    ...
    animation.registry.category_configurator_dynamic_category = animation.Class.extend({
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                if(self.hasClass('grid_style')){
                    $.get("/theme_vouge/get_category_configurator_grid_style", {
                ...
                if(self.hasClass('icon_slider_style')){
                    $.get("/theme_vouge/get_category_configurator_icon_slider_style", {
                        'category_id': self.attr('category_id') || '',
                    }).then(function(data) {
                        if (data) {
                            $(data).appendTo(self.find('[class*=container]'));
                        ...
                        $('div#configurator-icon-slider').owlCarousel({
                            margin: 30,
                            responsiveClass: true,
                            items: 10,
                            loop: false,
                ...
                if(self.hasClass('list_style')){
                    $.get("/theme_vouge/get_category_configurator_list_style", {
                        'category_id': self.attr('category_id') || '',
                        'category_limit': self.attr('category_limit') || 10,
                        'config_title': self.attr('config_title') || '',
                    }).then(function(data) {
                ...
                if(self.hasClass('slider_style')){
                    $.get("/theme_vouge/get_category_configurator_slider_style", {
                        'category_id': self.attr('category_id') || '',
                        'category_limit': self.attr('category_limit') || 10,
                        'config_title': self.attr('config_title') || '',
                        'config_slider_description': self.attr('config_slider_description') || '',
    ...
    animation.registry.brand_configurator_dynamic_brand = animation.Class.extend({
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                if(self.hasClass('grid_style')){
                    $.get("/theme_vouge/get_brand_configurator_grid_style", {
                ...
                if(self.hasClass('slider_style')){
                    $.get("/theme_vouge/get_brand_configurator_slider_style", {
                        'brand_id': self.attr('brand_id') || '',
                        'brand_limit': self.attr('brand_limit') || 10,
                        'config_title': self.attr('config_title') || '',
                        'config_slider_description': self.attr('config_slider_description') || '',
    ...
    animation.registry.theme_vouge_product_banner = animation.Class.extend({
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_vouge/get_product_banner_details_xml", {
    ...
    animation.registry.s_bizople_theme_blog_slider_snippet = animation.Class.extend({
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_vouge/second_blog_get_dynamic_slider", {
                    ...
                    if (data) {
                        ...
                        ajax.jsonRpc('/theme_vouge/blog_image_effect_config', 'call', {
    ...
    $(document).ready(function(){
        ...
        $('.search_filter_attributes').keyup(function(e){
            ...
            var loop_el = $(this).parent().find('li')
