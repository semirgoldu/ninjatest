odoo.define('theme_vouge.brand_configurator_options', function(require) {
    'use strict';
    ...
    options.registry.theme_vouge_brand_configurator = options.Class.extend({
        xmlDependencies: ['/theme_vouge/static/src/xml/brand_configurator.xml'],
        events:{
        ...
        prod_config: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                self.$modal = $(qweb.render("theme_vouge.select_brand_configurator"));
                ...
                $.get("/theme_vouge/get_brand_configurator_brand", {
