odoo.define('theme_vouge.ButtonStyle', function (require) {
'use strict';
	...
	const VougeLinkDialog = _DialogLinkWidget.include({
	...
	const VougeLinkTools = LinkTools.include({
        xmlDependencies: (LinkTools.prototype.xmlDependencies || [])
        .concat([
            '/theme_vouge/static/src/xml/button_editor.xml',
        ]),
		_getLinkOptions: function () {
	        const options = [
