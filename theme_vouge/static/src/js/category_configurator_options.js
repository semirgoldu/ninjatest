odoo.define('theme_vouge.category_configurator_options', function(require) {
    'use strict';
    ...
    options.registry.theme_vouge_category_configurator = options.Class.extend({
        xmlDependencies: ['/theme_vouge/static/src/xml/category_configurator.xml'],
        events:{
        ...
        prod_config: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                self.$modal = $(qweb.render("theme_vouge.select_category_configurator"));
                ...
                $.get("/theme_vouge/get_category_configurator_category", {
                ...
                /* ek var configuration save karya pachi biji var open kare to saved config select lave start */
                    ...
                    if (self.$target.hasClass("icon_slider_style")){
                        self.$modal.find(".display_style .dropdown-toggle").html('Icon Slider')
                        self.$modal.find(".category_preview").addClass('icon_slider_style')
                        self.$modal.find('.column_limit').addClass('d-none')
                        self.$modal.find('.category_limit_one_slide').addClass('d-none')
                        self.$modal.find('.category_limit').addClass('d-none')
                        self.$modal.find(".card_style").removeClass('d-none')
                ...
                $('.category_configurator_option .dropdown-item').on('click', function() {
                    ...
                    if($(this).attr('data-select-display-class')){
                        ...
                        self.$target.removeClass('grid_style list_style slider_style icon_slider_style')
                        self.$target.addClass(add_class);
                        self.$modal.find('.category_preview').removeClass('grid_style list_style slider_style icon_slider_style')
                        ...
                        if (add_class == "grid_style"){
                            ...
                            self.$modal.find('.slider_autoslide').addClass('d-none')
                            self.$modal.find('.slider_slidespeed').addClass('d-none')
                            self.$modal.find('.category_limit').removeClass('d-none')
                        ...
                        if (add_class == "icon_slider_style"){
                            self.$modal.find('.column_limit').addClass('d-none')
                            self.$modal.find('.category_limit_one_slide').addClass('d-none')
                            self.$modal.find('.category_limit').addClass('d-none')
                            self.$modal.find(".card_style").removeClass('d-none')
