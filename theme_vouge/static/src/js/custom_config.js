odoo.define('theme_vouge.custom_config', function(require){
'use strict';
		...
		start: function () {
			...
			/*header 4 sidebar*/
		  	$("#show_header4_menu").on("click", function(e) {
			    $(".sidebar-wrapper.header4_sidebar").parents(".blured-bg").addClass("active");
			    $(".sidebar-wrapper.header4_sidebar").addClass("toggled");
			    e.stopPropagation()
	 	 	});
		  	$("#close_header4_sidebar").on("click", function(e) {
			    $(".sidebar-wrapper.header4_sidebar").parents(".blured-bg").removeClass("active");
		  	...
		  	/* header cart sidebar */
			    ...
			    $("#cart_sidebar").parents(".blured-bg").addClass("active");
	...
	publicWidget.registry.shoppagejs = publicWidget.Widget.extend({
		selector: ".vouge_shop",
		events: {
	        'click .vouge_grid_button > .grid4': '_grid4',
	        'click .vouge_grid_button > .grid3': '_grid3',
	        'click .vouge_grid_button > .grid2': '_grid2',
	        'click .vouge_grid_button > .sale_list': '_salelist',
	    },
		start: function () {
			$("body").addClass("blured-bg");
			/*brand check box */
			...
			if (size >= 1200){
				$(function() {
				    if ( !$(".vouge_shop #products_grid .grid4").hasClass("active") && !$(".vouge_shop #products_grid .grid3").hasClass("active") && !$(".vouge_shop #products_grid .grid2").hasClass("active") && !$(".vouge_shop #products_grid .sale_list").hasClass("active")) {
				      $(".vouge_shop #products_grid .grid4").addClass("active");
				    }
				});
			}
			if (size <= 1199){
				$(function() {
				    if ( !$(".vouge_shop #products_grid .grid3").hasClass("active") && !$(".vouge_shop #products_grid .grid2").hasClass("active") && !$(".vouge_shop #products_grid .sale_list").hasClass("active")) {
				      $(".vouge_shop #products_grid .grid3").addClass("active");
				    }
				});
			}
			...
			/* category sidebar js shop page */
		  	...
		  	$(document).on("click", function(e) {
			    if (!$(e.target).closest('.mobile-categ-sidebar').length) {
					$(".mobile-categ-sidebar.toggled").parents(".blured-bg").removeClass("active");
			      	$(".mobile-categ-sidebar.toggled").removeClass("toggled");
			    }
		  	});
		  	$(document).on("click", function(e) {
		  	...
		  	$("#vouge_categ_slider").owlCarousel({
		  	...
		  	$("#vouge_sub_categ_slider").owlCarousel({
		      autoPlay: 3000, //Set AutoPlay to 3 seconds
		      responsiveClass: true,
		      items : 4,
		      loop: false,
