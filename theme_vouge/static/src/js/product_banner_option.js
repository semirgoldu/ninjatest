odoo.define('theme_vouge.product_banner_options', function(require) {
    'use strict';
    ...
    // ajax.loadXML('/theme_vouge/static/src/xml/product_banner.xml', qweb);

    options.registry.add_product_banner = options.Class.extend({
        xmlDependencies: ['/theme_vouge/static/src/xml/product_banner.xml'],
    	events:{
	    ...
	    _addproductsection: function () {
            ...
            self.$modal = $(qweb.render("theme_vouge.select_product_banner"));
            ...
            $pro_sub_data.on('click', function() {
                ...
                ajax.jsonRpc('/theme_vouge/get_product_banner_details_js', 'call', {
                    'product_id': product_id
                }).then(function(res) {
                    if (res) {
                        var demo_section = $(qweb.render("theme_vouge.edit_mode_product_banner"));
