odoo.define("theme_vouge.product_search", function (require) {
"use strict";
...
publicWidget.registry.VougeSearchBar = publicWidget.Widget.extend({
    ...
    events: {
        // "input .search-query-bizople": "_onInput",
        // "input .search-query-bizople-popup": "_onInput",
